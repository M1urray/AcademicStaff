...
namespace Latest_Staff_Portal.Controllers
{
    public class DocumentApprovalController : Controller
    {
        ...
        public JsonResult DelegateDocument(string DocNo, int TableID)
        {
            try
            {
                string Msg = "";
                Credentials.ObjNav.DelegateDocumentApproval(DocNo, TableID);
                Msg = "Approval Successfully Delegated";
