    ...
    public class LoginController : Controller
    {
        ...
        public JsonResult LoginUser(Authedication userlogin)
        {
            ...
            try
            {
                ...
                //else
                //{
                //    userID = @"ICMHS\" + UserName;
                //}
                //string Redirect = "/Dashboard/Dashboard";
                //Session["Username"] = UserName.ToUpper().Replace("-", "/");
                //Session["UserID"] = userID;
                //SetUserAuthedication(UserName, "", "FULLTIME");
                //msg = Redirect;
                //success = true;

                using (PrincipalContext pc = new PrincipalContext(ContextType.Domain, "192.168.1.2"))
                {
                    ...
                    if (isValid == true)
                    {
                        ...
                        string Redirect = "/Dashboard/Dashboard";
                        string page = "EmployeeList?$filter=No eq '" + UserName.ToUpper().Replace("-", "/") + "'&format=json";
