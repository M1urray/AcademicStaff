    ...
    public class LoginController : Controller
    {
        ...
        public JsonResult LoginUser(Authedication userlogin)
        {
            ...
            try
            {
                ...
                using (PrincipalContext pc = new PrincipalContext(ContextType.Domain, "10.10.1.10"))
                {
                    bool isValid = false;
            ...
            try
            {
                if (email != "")
                {
                    ...
                    if (ok == "CHANGED")
                    {
                        ...
                        {
                            err.Message = "A New password has been sent to your Email<b>(" + email + ")</b>. Use it to login. Remember to change your password after you login";
                            err.success = true;
                        }
                        else
                        {
