...
//     public class StandingImpReimbursementController : Controller
//     {
//
...
//         }
//
//         public PartialViewResult EditReimbLine(string ItemNo, string LineNo)
//         {
...
//                 partialViewResult = this.PartialView("~/Views/StandingImpReimbursement/ReimbItemForm.cshtml", new ImprestTypesList()
//                 {
//                     Code = ItemNo,
//                     ListOfImprestTypes = (
...
//         {
//             return base.PartialView("~/Views/StandingImpReimbursement/FileAttachmentForm.cshtml");
//         }
//
...
//                         }
//                     }
//                     action = base.View("~/Views/StandingImpReimbursement/NewRequest.cshtml", new DropdownListData()
//                     {
//                         Code = "",
//                         ListOfddlData = (
//                             from x in Dim1List
...
//         }
//
//         public PartialViewResult ReimbursementDocumentLines(string DocNo, string Status)
//         {
//             PartialViewResult partialViewResult;
//             try
//             {
...
//                     }
//                 }
//                 partialViewResult = this.PartialView("~/Views/StandingImpReimbursement/ReimbDocumentLineView.cshtml", new ImprestLinesList()
//                 {
//                     Status = Status,
...
//         }
//
//         public ActionResult ReimbursementDocView(string DocNo)
//         {
//             ActionResult action;
//             try
//             {
...
//         }
//
//         public PartialViewResult ReimbursementListPartialView()
//         {
//             PartialViewResult partialViewResult;
//             try
//             {
...
//                 string page = string.Concat("PaymentHeader?$filter=PF_No eq '", StaffNo, "' and Request_Type eq 'Reimbursement'&$format=json");
//                 using (StreamReader streamReader = new StreamReader(Credentials.GetOdataData(page).GetResponseStream()))
//                 {
//                     foreach (JObject config in (IEnumerable<JToken>)JObject.Parse(streamReader.ReadToEnd())["value"])
//                     {
...
//                     }
//                 }
//                 partialViewResult = this.PartialView("~/Views/StandingImpReimbursement/ReimbursementReqListView.cshtml",
//                     from x in STImpList
...
//
//         [AcceptVerbs(HttpVerbs.Post)]
//         public JsonResult RemoveReimbLine(string DocNo, string LnNo)
//         {
//             JsonResult jsonResult;
//             try
//             {
...
//                 }
//                 jsonResult = base.Json(new { message = string.Concat("Standing Imprest Reimbursement Requisition, Document No ", DocNo, " send for approval Successfully"), success = true }, JsonRequestBehavior.AllowGet);
//             }
//             catch (Exception exception)
//             {
//                 Exception ex = exception;
...
//
//         [AcceptVerbs(HttpVerbs.Post)]
//         public JsonResult SubmitReimbLine(string DocNo, string item, string Amount)
//         {
//             JsonResult jsonResult;
//             try
//             {
...
//
//         [AcceptVerbs(HttpVerbs.Post)]
//         public ActionResult SubmitReimbursementRequisition(string ReqNo, string RespC, string Remarks)
//         {
...
//                 string DocNo = Credentials.ObjNav.InsertStandingImprestsurrender(ReqNo, RespC, Remarks, StaffNo, UserID, 2);
//                 if (DocNo == "")
//                 {
...
//                 else
//                 {
//                     string Redirect = string.Concat("/StandingImpReimbursement/ReimbursementDocView?DocNo=", DocNo);
//                     base.Session["SuccessMsg"] = string.Concat("Standing Imprest Reimbursement Requisition, Document No: ", DocNo, ", created Successfully");
//                     actionResult = base.Json(new { message = Redirect, success = true }, JsonRequestBehavior.AllowGet);
//                 }
//             }
//             catch (Exception exception)
//             {
