    ...
    public class CommonController : Controller
    {
        ...
        public PartialViewResult DocumentAttachmentsToApprove(string DocNo, int TableID)
        {
            try
            {
                ...
                if (TableID == 70134720)
                {
                    page = "DocumentAttachment?$filter=(Table_ID eq 70134877 or Table_ID eq 70134720) and No eq '" + DocNo + "'&format=json";
                }
                else
                {
                    page = "DocumentAttachment?$filter=Table_ID eq " + TableID + " and No eq '" + DocNo + "'&format=json";
                }
        ...
        public PartialViewResult DocumentAttachmentsOnlineApp(string DocNo)
        {
            try
            {
                #region Document Attachment
                List<DocumentAttachment> DocAttachment = new List<DocumentAttachment>();
                string page = "DocumentAttachment?$filter=(Table_ID eq 70134877 or Table_ID eq 70134720) and No eq '" + DocNo + "'&format=json";
