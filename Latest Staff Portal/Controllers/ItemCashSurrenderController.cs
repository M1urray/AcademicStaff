            ...
            try
            {
                ...
                using (var streamReader = new StreamReader(httpResponse.GetResponseStream()))
                {
                    ...
                    foreach (JObject config in details["value"])
                    {
                        ...
                        ImList.ImpDocNo = (string)config["ItemCash_Issue_Doc_No"];
                ...
                else
                {
                    ...
                    using (var streamReader = new StreamReader(httpResponse.GetResponseStream()))
                    {
                        ...
                        foreach (JObject config in details["value"])
                        {
                            ...
                            ImpDoc.ItemCashNo = (string)config["ItemCash_Issue_Doc_No"];
                            ImpDoc.ImpIssueDate = (string)config["ItemCash_Issue_Date"];
