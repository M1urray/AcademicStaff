    ...
    public class LecturerController : Controller
    {
        ...
        public ActionResult LecturerList()
        {
            ...
            else
            {
                ...
                //}
                page = "EmployeeList?$filter=Lecturer eq true and Status eq 'Active'&$format=json";
        ...
        public PartialViewResult GetLecturerAssinedUnits(string Lecturer)
        {
            ...
            string page = "Lecturers_Units?$filter=Lecturer eq '" + Lecturer + "' and Semester eq '" + Sem + "'&$format=json";
            ...
            #endregion
            #region Exam Sem
            string ESem = CommonClass.ExamSemester();
            string pageE = "Lecturers_Units?$filter=Lecturer eq '" + Lecturer + "' and Semester eq '" + ESem + "'&$format=json";
        ...
        public JsonResult GetProgrammeStageUnits(string Prog, string Stage)
        {
            try
            {
                ...
                //string page = "UnitSubject?$filter=ProgrammeCode eq '" + Prog + "' and StageCode eq '"+ Stage + "'&$format=json";
        ...
        public JsonResult AssignLecturerUnit(SubmitLecAssignedUnit UnitDetails)
        {
            try
            {
                Credentials.ObjNav.AssignLecturerUnit(UnitDetails.Lect, UnitDetails.Prog, "", UnitDetails.Sem, UnitDetails.Unit, "MAIN", "", "", 0, false);
        ...
        public PartialViewResult LoadClassAttendanceList()
        {
            if (Session["Sem"] != null && Session["Unit"] != null && Session["Campus"] != null || Session["ClassCode"] != null)
            {
                ...
                if (IsAss)
                {
                    //page = "ClassAttendanceHeader?$filter=Unit_Code eq '" + Unit + "' and Semester_Code eq '"
                    //   + Sem + "' and Campus_Code eq '" + Campus + "' and Section eq '" + classCode + "'&$format=json";
                    page = "ClassAttendanceHeader?$filter=Unit_Code eq '" + Unit + "' and Semester_Code eq '"
                       + Sem + "'&$format=json";
                }
                else
                {
                    //page = "ClassAttendanceHeader?$filter=Lecturer_Code eq '" + Lec + "' and Unit_Code eq '" + Unit + "' and Semester_Code eq '"
                    //   + Sem + "' and Campus_Code eq '" + Campus + "' and Section eq '" + classCode + "'&$format=json";
                    page = "ClassAttendanceHeader?$filter=Lecturer_Code eq '" + Lec + "' and Unit_Code eq '" + Unit + "' and Semester_Code eq '"
                       + Sem + "'&$format=json";
                }
        ...
        public PartialViewResult LoadClassAttendanceStudents(string DocNo)
        {
            if (Session["Sem"] != null && Session["Unit"] != null && Session["Campus"] != null || Session["ClassCode"] != null)
            {
                ...
                {
                    #region Week and Day
                    string pageAtt = "ClassAttendanceHeader?$select=Week_Code,Day_Code&$filter=Code eq '" + DocNo + "'&$format=json";
        ...
        protected bool ClassAttendanceWeekTaken(string StaffNo, string Semester, string Unit, string Campus, string Wk, string Sec)
        {
            ...
            try
            {
                //string pageAtt = "ClassAttendanceHeader?$select=Week_Code&$filter=Lecturer_Code eq '" + StaffNo + "' and Semester_Code eq '" + Semester + "' and UnitCode eq '" +
                //    Unit + "' and CampusCode eq '" + Campus + "' and Week_Code eq '" + Wk + "' and Section eq '" + Sec + "'&$format=json";
                string pageAtt = "ClassAttendanceHeader?$select=Week_Code&$filter=Lecturer_Code eq '" + StaffNo + "' and Semester_Code eq '" + Semester + "' and UnitCode eq '" +
                   Unit + "' and Week_Code eq '" + Wk + "'&$format=json";
