                                    ...
                                    foreach (JObject config in details["value"])
                                    {
                                        ...
                                        else
                                        {
                                            if (AssinedScore > 0)
                                            {
                                                ...
                                                if (((string)config["Exam_Type"]).Contains("EXAM"))
                                                {
                                                    examType = "EXAM";
                                                }
                                                else
        ...
        public JsonResult GetUnitReports(string ReportType, string RType)
        {
            try
            {
                ...
                if (Session["Sem"] != null && Session["Unit"] != null && Session["Campus"] != null)
                {
                    ...
                    if (ReportType == "CLATT")
                    {
                        //Credentials.ObjNav.PrintClassList("", Unit, "", Sem, ClassCode, Campus, "CLASSLIST-" + _filename + extn);
                        filename = "CLASSLIST-" + _filename + extn;
                    }
                    if (ReportType == "EXAMATT")
                    {
                        //Credentials.ObjNav.GenerateExamAttendanceList("", Unit, "", Sem, ClassCode, Campus, "EXAMATTENDANCE-" + _filename + extn);
