...
var GradeComplainLink = function () {
    ShowProgress();
    window.location = "/GradeComplaint/Grade_Complaint";
}
...
var LecturerEvaluationLink = function () {
    ShowProgress();
    window.location = "/Lecturer/Lecturer_Course_Evaluation";
}
var PartTimeRequisitionLink = function () {
    ShowProgress();
    window.location = "/Lecturer/PartTimeRequistionList";
}
...
var CourseEvalLink = function () {
    ShowProgress();
    window.location = "/Lecturer/CourseEvaluationReports";
}
...
var TimetableProjectionLink = function () {
    ShowProgress();
    window.location = "/TimeTable/TimeTableProjections";
}
var LeaveRequisitionLink = function () {
    ShowProgress();
    window.location = "/Leave/LeaveRequisitionList";
}
...
var ImprestRequisitiontLink = function () {
    ShowProgress();
...
var StaffClearancelink = function () {
    ShowProgress();
    window.location = "/StaffClearance/StaffClearanceRequestList";
}
var PayslipViewLink = function () {
    ShowProgress();
    window.location = "/ViewDocument/DocumentViewPayslip";
}
